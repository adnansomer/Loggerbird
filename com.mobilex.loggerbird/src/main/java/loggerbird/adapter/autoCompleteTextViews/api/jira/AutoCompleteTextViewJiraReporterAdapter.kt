...
//Custom autoCompleteTextView loggerbird.adapter class for jira reporter.
/**
 * @param context is for getting reference from the application context.
 * @param resource is for getting the custom layout resources of the loggerbird.adapter.
 * @param arrayListReporterName is for getting the list that will be used in the autoCompleteTextView.
 */
internal class AutoCompleteTextViewJiraReporterAdapter(
    context: Context,
    @LayoutRes private val resource: Int,
    private val arrayListReporterName: ArrayList<String>
) : ArrayAdapter<String>(context, resource, arrayListReporterName) {
    ...
    override fun getCount(): Int {
        return arrayListReporterName.size
    }
    ...
    override fun getItem(position: Int): String? {
        return arrayListReporterName[position]
    }
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup): View {
        ...
        val textViewName = view.findViewById<TextView>(R.id.textView_jira_reporter_name)
        textViewName.text = arrayListReporterName[position]
        return view
    }
}