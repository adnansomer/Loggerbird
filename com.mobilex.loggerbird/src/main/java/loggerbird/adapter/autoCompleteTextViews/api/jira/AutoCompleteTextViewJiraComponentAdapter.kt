...
//Custom autoCompleteTextView loggerbird.adapter class for jira component
/**
 * @param context is for getting reference from the application context.
 * @param resource is for getting the custom layout resources of the loggerbird.adapter.
 * @param arrayListComponentName is for getting the list that will be used in the autoCompleteTextView.
 */
internal class AutoCompleteTextViewJiraComponentAdapter(
    context: Context,
    @LayoutRes private val resource: Int,
    private val arrayListComponentName: ArrayList<String>
) : ArrayAdapter<String>(context, resource, arrayListComponentName) {
    ...
    override fun getCount(): Int {
        return arrayListComponentName.size
    }
    ...
    override fun getItem(position: Int): String? {
        return arrayListComponentName[position]
    }
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup): View {
        ...
        val textViewName = view.findViewById<TextView>(R.id.textView_jira_component_name)
        textViewName.text = arrayListComponentName[position]
        return view
    }
}