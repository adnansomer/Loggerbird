...
//Custom autoCompleteTextView loggerbird.adapter class for github repositories.
/**
 * @param context is for getting reference from the application context.
 * @param resource is for getting the custom layout resources of the loggerbird.adapter.
 * @param arrayListRepoName is for getting the list that will be used in the autoCompleteTextView.
 */
internal class AutoCompleteTextViewGithubRepoAdapter(
    context: Context,
    @LayoutRes private val resource: Int,
    private val arrayListRepoName: ArrayList<String>
) : ArrayAdapter<String>(context, resource, arrayListRepoName) {
    ...
    override fun getItem(position: Int): String? {
        return arrayListRepoName[position]
    }
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup): View {
        ...
        val textViewName = view.findViewById<TextView>(R.id.textView_github_repo_name)
        textViewName.text = arrayListRepoName[position]
        return view
    }
}