...
//Custom autoCompleteTextView loggerbird.adapter class for jira sprint.
/**
 * @param context is for getting reference from the application context.
 * @param resource is for getting the custom layout resources of the loggerbird.adapter.
 * @param arrayListSprintName is for getting the list that will be used in the autoCompleteTextView.
 */
internal class AutoCompleteTextViewJiraSprintAdapter(
    context: Context,
    @LayoutRes private val resource: Int,
    private val arrayListSprintName: ArrayList<String>
) : ArrayAdapter<String>(context, resource, arrayListSprintName) {
    ...
    override fun getCount(): Int {
        return arrayListSprintName.size
    }
    ...
    override fun getItem(position: Int): String? {
        return arrayListSprintName[position]
    }
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup): View {
        ...
        val textViewName = view.findViewById<TextView>(R.id.textView_jira_sprint_name)
        textViewName.text = arrayListSprintName[position]
        return view
    }
}