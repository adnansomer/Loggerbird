...
//Custom autoCompleteTextView loggerbird.adapter class for bitbucket kinds.
/**
 * @param context is for getting reference from the application context.
 * @param resource is for getting the custom layout resources of the loggerbird.adapter.
 * @param arrayListKindName is for getting the list that will be used in the autoCompleteTextView.
 */
internal class AutoCompleteTextViewBitbucketKindAdapter(
    context: Context,
    @LayoutRes private val resource: Int,
    private val arrayListKindName: ArrayList<String>
) : ArrayAdapter<String>(context, resource, arrayListKindName) {
    ...
    override fun getItem(position: Int): String? {
        return arrayListKindName[position]
    }
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup): View {
        ...
        val textViewName = view.findViewById<TextView>(R.id.textView_bitbucket_kind_name)
        textViewName.text = arrayListKindName[position]
        return view
    }
}