...
//Custom autoCompleteTextView loggerbird.adapter class for gitlab project.
/**
 ...
 */
internal class AutoCompleteTextViewGitlabProjectAdapter(
    context: Context,
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup): View {
        ...
        val textViewName = view.findViewById<TextView>(R.id.textView_gitlab_project_name)
