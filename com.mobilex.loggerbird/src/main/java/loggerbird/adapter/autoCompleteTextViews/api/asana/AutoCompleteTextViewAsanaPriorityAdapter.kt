...
//Custom autoCompleteTextView loggerbird.adapter class for asana priority.
/**
 * @param context is for getting reference from the application context.
 * @param resource is for getting the custom layout resources of the loggerbird.adapter.
 * @param arrayListPriorityName is for getting the list that will be used in the autoCompleteTextView.
 */
internal class AutoCompleteTextViewAsanaPriorityAdapter(
    context: Context,
    @LayoutRes private val resource: Int,
    private val arrayListPriorityName: ArrayList<String>
) : ArrayAdapter<String>(context, resource, arrayListPriorityName) {
    ...
    override fun getCount(): Int {
        return arrayListPriorityName.size
    }
    ...
    override fun getItem(position: Int): String? {
        return arrayListPriorityName[position]
    }
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup): View {
        ...
        val textViewName = view.findViewById<TextView>(R.id.textView_asana_priority_name)
        textViewName.text = arrayListPriorityName[position]
        return view
    }
}