...
//Custom autoCompleteTextView loggerbird.adapter class for bitbucket assignee.
/**
 * @param context is for getting reference from the application context.
 * @param resource is for getting the custom layout resources of the loggerbird.adapter.
 * @param arrayLisAssigneeName is for getting the list that will be used in the autoCompleteTextView.
 */
internal class AutoCompleteTextViewBitbucketAssigneeAdapter(
    context: Context,
    @LayoutRes private val resource: Int,
    private val arrayLisAssigneeName: ArrayList<String>
) : ArrayAdapter<String>(context, resource, arrayLisAssigneeName) {
    ...
    override fun getCount(): Int {
        return arrayLisAssigneeName.size
    }
    ...
    override fun getItem(position: Int): String? {
        return arrayLisAssigneeName[position]
    }
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup): View {
        ...
        val textViewName = view.findViewById<TextView>(R.id.textView_bitbucket_assignee_name)
        textViewName.text = arrayLisAssigneeName[position]
        return view
    }
}