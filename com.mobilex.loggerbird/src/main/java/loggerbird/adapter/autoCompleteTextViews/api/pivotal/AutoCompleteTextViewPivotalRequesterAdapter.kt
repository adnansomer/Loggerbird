...
//Custom autoCompleteTextView loggerbird.adapter class for pivotal requesters.
/**
 * @param context is for getting reference from the application context.
 * @param resource is for getting the custom layout resources of the loggerbird.adapter.
 * @param arrayListRequestersName is for getting the list that will be used in the autoCompleteTextView.
 */
internal class AutoCompleteTextViewPivotalRequesterAdapter(
    context: Context,
    @LayoutRes private val resource: Int,
    private val arrayListRequestersName: ArrayList<String>
) : ArrayAdapter<String>(context, resource, arrayListRequestersName) {
    ...
    override fun getCount(): Int {
        return arrayListRequestersName.size
    }
    ...
    override fun getItem(position: Int): String? {
        return arrayListRequestersName[position]
    }
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup): View {
        ...
        val textViewName = view.findViewById<TextView>(R.id.textView_pivotal_requester_name)
        textViewName.text = arrayListRequestersName[position]
        return view
    }
}