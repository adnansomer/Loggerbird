...
//Custom autoCompleteTextView loggerbird.adapter class for basecamp projects.
/**
 ...
 */
internal class AutoCompleteTextViewBasecampProjectAdapter(
    context: Context,
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup): View {
        ...
        val textViewName = view.findViewById<TextView>(R.id.textView_basecamp_project_name)
