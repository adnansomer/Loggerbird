...
//Custom autoCompleteTextView loggerbird.adapter class for github assignee.
/**
 ...
 */
internal class AutoCompleteTextViewGithubAssigneeAdapter(
    context: Context,
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup): View {
        ...
        val textViewName = view.findViewById<TextView>(R.id.textView_github_assignee_name)
