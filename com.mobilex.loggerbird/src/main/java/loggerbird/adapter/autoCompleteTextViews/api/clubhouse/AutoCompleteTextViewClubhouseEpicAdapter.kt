...
//Custom autoCompleteTextView loggerbird.adapter class for clubhouse epics.
/**
 * @param context is for getting reference from the application context.
 * @param resource is for getting the custom layout resources of the loggerbird.adapter.
 * @param arrayListEpicName is for getting the list that will be used in the autoCompleteTextView.
 */
internal class AutoCompleteTextViewClubhouseEpicAdapter(
    context: Context,
    @LayoutRes private val resource: Int,
    private val arrayListEpicName: ArrayList<String>
) : ArrayAdapter<String>(context, resource, arrayListEpicName) {
    ...
    override fun getItem(position: Int): String? {
        return arrayListEpicName[position]
    }
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup): View {
        ...
        val textViewName = view.findViewById<TextView>(R.id.textView_clubhouse_epic_name)
        textViewName.text = arrayListEpicName[position]
        return view
    }
}