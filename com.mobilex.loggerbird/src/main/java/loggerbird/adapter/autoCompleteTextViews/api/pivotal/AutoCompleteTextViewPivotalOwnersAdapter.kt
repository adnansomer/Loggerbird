...
//Custom autoCompleteTextView loggerbird.adapter class for pivotal owners.
/**
 * @param context is for getting reference from the application context.
 * @param resource is for getting the custom layout resources of the loggerbird.adapter.
 * @param arrayListOwnersName is for getting the list that will be used in the autoCompleteTextView.
 */
internal class AutoCompleteTextViewPivotalOwnersAdapter(
    context: Context,
    @LayoutRes private val resource: Int,
    private val arrayListOwnersName: ArrayList<String>
) : ArrayAdapter<String>(context, resource, arrayListOwnersName) {
    ...
    override fun getCount(): Int {
        return arrayListOwnersName.size
    }
    ...
    override fun getItem(position: Int): String? {
        return arrayListOwnersName[position]
    }
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup): View {
        ...
        val textViewName = view.findViewById<TextView>(R.id.textView_pivotal_owners_name)
        textViewName.text = arrayListOwnersName[position]
        return view
    }
}