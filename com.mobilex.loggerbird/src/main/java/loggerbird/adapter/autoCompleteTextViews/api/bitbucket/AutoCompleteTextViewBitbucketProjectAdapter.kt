...
//Custom autoCompleteTextView loggerbird.adapter class for bitbucket projects.
/**
 ...
 */
internal class AutoCompleteTextViewBitbucketProjectAdapter(
    context: Context,
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup): View {
        ...
        val textViewName = view.findViewById<TextView>(R.id.textView_bitbucket_project_name)
