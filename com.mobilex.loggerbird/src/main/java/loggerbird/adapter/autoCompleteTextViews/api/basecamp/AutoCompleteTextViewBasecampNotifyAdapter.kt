...
//Custom autoCompleteTextView loggerbird.adapter class for basecamp notifications.
/**
 * @param context is for getting reference from the application context.
 * @param resource is for getting the custom layout resources of the loggerbird.adapter.
 * @param arrayListNotifyName is for getting the list that will be used in the autoCompleteTextView.
 */
internal class AutoCompleteTextViewBasecampNotifyAdapter(
    context: Context,
    @LayoutRes private val resource: Int,
    private val arrayListNotifyName: ArrayList<String>
) : ArrayAdapter<String>(context, resource, arrayListNotifyName) {
    ...
    override fun getCount(): Int {
        return arrayListNotifyName.size
    }
    ...
    override fun getItem(position: Int): String? {
        return arrayListNotifyName[position]
    }
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup): View {
        ...
        val textViewName = view.findViewById<TextView>(R.id.textView_basecamp_notify_name)
        textViewName.text = arrayListNotifyName[position]
        return view
    }
}