...
//Custom autoCompleteTextView loggerbird.adapter class for jira priority.
/**
 ...
 */
internal class AutoCompleteTextViewJiraPriorityAdapter(
    context: Context,
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup): View {
        ...
        val textViewName = view.findViewById<TextView>(R.id.textView_jira_priority_name)
