...
//Custom autoCompleteTextView loggerbird.adapter class for jira project.
/**
 ...
 */
internal class AutoCompleteTextViewJiraProjectAdapter(
    context: Context,
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup): View {
        ...
        val textViewName = view.findViewById<TextView>(R.id.textView_jira_project_name)
