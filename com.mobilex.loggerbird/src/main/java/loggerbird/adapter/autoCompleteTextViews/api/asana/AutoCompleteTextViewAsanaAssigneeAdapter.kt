...
//Custom autoCompleteTextView loggerbird.adapter class for asana assignees.
/**
 ...
 */
internal class AutoCompleteTextViewAsanaAssigneeAdapter(
    context: Context,
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup): View {
        ...
        val textViewName = view.findViewById<TextView>(R.id.textView_asana_assignee_name)
