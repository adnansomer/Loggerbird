...
//Custom autoCompleteTextView loggerbird.adapter class for trello members.
/**
 * @param context is for getting reference from the application context.
 * @param resource is for getting the custom layout resources of the loggerbird.adapter.
 * @param arrayListMemberName is for getting the list that will be used in the autoCompleteTextView.
 */
internal class AutoCompleteTextViewTrelloMemberAdapter(
    context: Context,
    @LayoutRes private val resource: Int,
    private val arrayListMemberName: ArrayList<String>
) : ArrayAdapter<String>(context, resource, arrayListMemberName) {
    ...
    override fun getCount(): Int {
        return arrayListMemberName.size
    }
    ...
    override fun getItem(position: Int): String? {
        return arrayListMemberName[position]
    }
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup): View {
        ...
        val textViewName = view.findViewById<TextView>(R.id.textView_trello_member_name)
        textViewName.text = arrayListMemberName[position]
        return view
    }
}