...
//Custom autoCompleteTextView loggerbird.adapter class for gitlab milestone.
/**
 ...
 */
internal class AutoCompleteTextViewGitlabMilestoneAdapter(
    context: Context,
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup): View {
        ...
        val textViewName = view.findViewById<TextView>(R.id.textView_gitlab_milestone_name)
