...
//Custom autoCompleteTextView loggerbird.adapter class for gitlab label.
/**
 ...
 */
internal class AutoCompleteTextViewGitlabLabelAdapter(
    context: Context,
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup): View {
        ...
        val textViewName = view.findViewById<TextView>(R.id.textView_gitlab_labels_name)
