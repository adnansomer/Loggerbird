...
//Custom autoCompleteTextView loggerbird.adapter class for jira epic name.
/**
 * @param context is for getting reference from the application context.
 * @param resource is for getting the custom layout resources of the loggerbird.adapter.
 * @param arrayListEpicNameName is for getting the list that will be used in the autoCompleteTextView.
 */
internal class AutoCompleteTextViewJiraEpicNameAdapter(
    context: Context,
    @LayoutRes private val resource: Int,
    private val arrayListEpicNameName: ArrayList<String>
) : ArrayAdapter<String>(context, resource, arrayListEpicNameName) {
    ...
    override fun getCount(): Int {
        return arrayListEpicNameName.size
    }
    ...
    override fun getItem(position: Int): String? {
        return arrayListEpicNameName[position]
    }
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup): View {
        ...
        val textViewName = view.findViewById<TextView>(R.id.textView_jira_epic_name_name)
        textViewName.text = arrayListEpicNameName[position]
        return view
    }
}