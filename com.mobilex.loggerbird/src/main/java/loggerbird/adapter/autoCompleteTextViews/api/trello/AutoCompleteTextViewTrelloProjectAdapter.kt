...
//Custom autoCompleteTextView loggerbird.adapter class for trello projects.
/**
 ...
 */
internal class AutoCompleteTextViewTrelloProjectAdapter(
    context: Context,
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup): View {
        ...
        val textViewName = view.findViewById<TextView>(R.id.textView_trello_project_name)
