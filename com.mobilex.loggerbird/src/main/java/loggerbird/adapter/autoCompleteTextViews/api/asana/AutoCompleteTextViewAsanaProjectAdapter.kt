...
//Custom autoCompleteTextView loggerbird.adapter class for asana projects.
/**
 ...
 */
internal class AutoCompleteTextViewAsanaProjectAdapter(
    context: Context,
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup): View {
        ...
        val textViewName = view.findViewById<TextView>(R.id.textView_asana_project_name)
