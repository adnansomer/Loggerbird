...
//Custom autoCompleteTextView loggerbird.adapter class for pivotal points.
/**
 * @param context is for getting reference from the application context.
 * @param resource is for getting the custom layout resources of the loggerbird.adapter.
 * @param arrayListPointsName is for getting the list that will be used in the autoCompleteTextView.
 */
internal class AutoCompleteTextViewPivotalPointsAdapter(
    context: Context,
    @LayoutRes private val resource: Int,
    private val arrayListPointsName: ArrayList<String>
) : ArrayAdapter<String>(context, resource, arrayListPointsName) {
    ...
    override fun getCount(): Int {
        return arrayListPointsName.size
    }
    ...
    override fun getItem(position: Int): String? {
        return arrayListPointsName[position]
    }
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup): View {
        ...
        val textViewName = view.findViewById<TextView>(R.id.textView_pivotal_points_name)
        textViewName.text = arrayListPointsName[position]
        return view
    }
}