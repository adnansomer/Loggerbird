...
//Custom autoCompleteTextView loggerbird.adapter class for clubhouse story types.
/**
 * @param context is for getting reference from the application context.
 * @param resource is for getting the custom layout resources of the loggerbird.adapter.
 * @param arrayListStoryTypeName is for getting the list that will be used in the autoCompleteTextView.
 */
internal class AutoCompleteTextViewClubhouseStoryTypeAdapter(
    context: Context,
    @LayoutRes private val resource: Int,
    private val arrayListStoryTypeName: ArrayList<String>
) : ArrayAdapter<String>(context, resource, arrayListStoryTypeName) {
    ...
    override fun getCount(): Int {
        return arrayListStoryTypeName.size
    }
    ...
    override fun getItem(position: Int): String? {
        return arrayListStoryTypeName[position]
    }
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup): View {
        ...
        val textViewName = view.findViewById<TextView>(R.id.textView_clubhouse_story_name)
        textViewName.text = arrayListStoryTypeName[position]
        return view
    }
}