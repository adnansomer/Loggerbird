...
//Custom autoCompleteTextView loggerbird.adapter class for github label.
/**
 ...
 */
internal class AutoCompleteTextViewGithubLabelAdapter(
    context: Context,
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup): View {
        ...
        val textViewName = view.findViewById<TextView>(R.id.textView_github_labels_name)
