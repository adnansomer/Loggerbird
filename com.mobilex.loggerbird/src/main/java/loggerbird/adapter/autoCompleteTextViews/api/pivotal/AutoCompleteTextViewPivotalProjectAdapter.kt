...
//Custom autoCompleteTextView loggerbird.adapter class for pivotal projects.
/**
 ...
 */
internal class AutoCompleteTextViewPivotalProjectAdapter(
    context: Context,
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup): View {
        ...
        val textViewName = view.findViewById<TextView>(R.id.textView_pivotal_project_name)
