package loggerbird.utils.email
...
import loggerbird.services.LoggerBirdFutureTaskService
import loggerbird.services.LoggerBirdService
import loggerbird.utils.other.DefaultConnectionQueueUtil
...
//                LoggerBirdService.loggerBirdService.finishShareLayout("single_email_error")
         ...
         * Variables:
         * @var internetConnectionUtil is used for instantiate the InternetConnectionUtil class and used it's network and internet check operations.
         * @var LoggerBird.uncaughtExceptionHandlerController is used for determining that there is an unhandled loggerbird.exception for callExceptionDetails method.
         * Exceptions:
         * @throws exception if error occurs then com.mobilex.loggerbird.loggerbird.exception message will be put in the queue with callExceptionDetails , which it's details gathered by takeExceptionDetails method and saves exceptions instance to the txt file with saveExceptionDetails method.
         * @throws LoggerBirdException if internet or network check gives exceptions.
         */
