...
class FloatingActionButtonAudioGlobalLayoutListener(private val floatingActionButtonAudio: FloatingActionButton? = null) :
    ...
    override fun onGlobalLayout() {
        try {
            if (LoggerBirdService.floatingActionButtonAudioLastDx != null && LoggerBirdService.floatingActionButtonAudioLastDy != null) {
                floatingActionButtonAudio?.x =
                    LoggerBirdService.floatingActionButtonAudioLastDx!!
                floatingActionButtonAudio?.y =
                    LoggerBirdService.floatingActionButtonAudioLastDy!!
            }
