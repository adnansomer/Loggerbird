...
class RecyclerViewEmailAdapter(
    private val fileList: ArrayList<RecyclerViewModel>,
    private val context: Context,
    private val activity: Activity,
    private val rootView: View
) :
    RecyclerView.Adapter<RecyclerViewEmailAdapter.ViewHolder>() {
    ...
    class ViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        fun bindItems(
            ...
            adapter: RecyclerViewEmailAdapter,
            position: Int,
...
//                    windowManagerParamsFeedback.gravity = Gravity.BOTTOM
                        ...
                        textViewTitle = viewRecyclerViewItems.findViewById(R.id.textView_recycler_view_email_title)
                        buttonYes = viewRecyclerViewItems.findViewById(R.id.button_recycler_view_email_yes)
                        buttonNo = viewRecyclerViewItems.findViewById(R.id.button_recycler_view_email_no)
                        buttonClicksEmailPopup(adapter = adapter , fileList = fileList , position = position)
                    }
                }
            } catch (e: Exception) {
                e.printStackTrace()
...
//            alertDialogItemDelete.show()
        ...
        private fun buttonClicksEmailPopup(fileList: ArrayList<RecyclerViewModel>, position: Int, adapter: RecyclerViewEmailAdapter) {
