...
class RecyclerViewAsanaSubAdapter(
    ...
    RecyclerView.Adapter<RecyclerViewAsanaSubAdapter.ViewHolder>() {
    ...
    class ViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        fun bindItems(
            ...
            adapter: RecyclerViewAsanaSubAdapter,
            position: Int,
...
//            alertDialogItemDelete.show()
        ...
        private fun buttonClicksAsanaPopup(fileList: ArrayList<RecyclerViewModel>, position: Int, adapter: RecyclerViewAsanaSubAdapter) {
