...
class RecyclerViewPivotalLabelAdapter(
    ...
    class ViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        fun bindItems(
            ...
            adapter: RecyclerViewPivotalLabelAdapter,
            position: Int,
...
//                    windowManagerParamsFeedback.gravity = Gravity.BOTTOM
                        ...
                        buttonClicksPivotalPopup(adapter = adapter , labelList = labelList , position = position)
                    }
                }
            } catch (e: Exception) {
                e.printStackTrace()
...
//            alertDialogItemDelete.show()
        ...
        private fun buttonClicksPivotalPopup(labelList: ArrayList<RecyclerViewModelLabel>, position: Int, adapter: RecyclerViewPivotalLabelAdapter) {
