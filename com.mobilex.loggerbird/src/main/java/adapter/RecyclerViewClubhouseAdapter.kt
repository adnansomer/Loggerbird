...
class RecyclerViewClubhouseAdapter(
    private val fileList: ArrayList<RecyclerViewModel>,
    private val context: Context,
    private val activity: Activity,
    private val rootView: View
) : RecyclerView.Adapter<RecyclerViewClubhouseAdapter.ViewHolder>() {
    ...
    class ViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        fun bindItems(
            ...
            adapter: RecyclerViewClubhouseAdapter,
            position: Int,
            ...
            try {
                ...
                if (Settings.canDrawOverlays(activity)) {
                    ...
                    if (windowManagerRecyclerViewItemPopup != null) {
                        ...
                        textViewTitle = viewRecyclerViewItems.findViewById(R.id.textView_recycler_view_clubhouse_title)
                        buttonYes = viewRecyclerViewItems.findViewById(R.id.button_recycler_view_clubhouse_yes)
                        buttonNo = viewRecyclerViewItems.findViewById(R.id.button_recycler_view_clubhouse_no)
