...
class RecyclerViewAsanaAdapter(
    private val fileList: ArrayList<RecyclerViewModel>,
    private val context: Context,
    private val activity: Activity,
    private val rootView: View
) :
    RecyclerView.Adapter<RecyclerViewAsanaAdapter.ViewHolder>() {
    ...
    class ViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        fun bindItems(
            ...
            adapter: RecyclerViewAsanaAdapter,
            position: Int,
...
//                    windowManagerParamsFeedback.gravity = Gravity.BOTTOM
                        ...
                        buttonClicksAsanaPopup(adapter = adapter , fileList = fileList , position = position)
                    }
                }
            } catch (e: Exception) {
                e.printStackTrace()
...
//            alertDialogItemDelete.show()
        ...
        private fun buttonClicksAsanaPopup(fileList: ArrayList<RecyclerViewModel>, position: Int, adapter: RecyclerViewAsanaAdapter) {
