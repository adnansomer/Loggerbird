...
class RecyclerViewPivotalAdapter(
    private val fileList: ArrayList<RecyclerViewModel>,
    private val context: Context,
    private val activity: Activity,
    private val rootView: View
) :
    RecyclerView.Adapter<RecyclerViewPivotalAdapter.ViewHolder>() {
    ...
    class ViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        fun bindItems(
            ...
            adapter: RecyclerViewPivotalAdapter,
            position: Int,
...
//                    windowManagerParamsFeedback.gravity = Gravity.BOTTOM
                        ...
                        buttonClicksPivotalPopup(adapter = adapter , fileList = fileList , position = position)
                    }
                }
            } catch (e: Exception) {
                e.printStackTrace()
...
//            alertDialogItemDelete.show()
        ...
        private fun buttonClicksPivotalPopup(fileList: ArrayList<RecyclerViewModel>, position: Int, adapter: RecyclerViewPivotalAdapter) {
