...
class RecyclerViewJiraIssueAdapter(
    private val fileList: ArrayList<RecyclerViewModelIssue>,
    ...
    class ViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        private fun removeItemPopup(
            activity: Activity,
            rootView: View,
            fileList: ArrayList<RecyclerViewModelIssue>,
            position: Int,
            adapter: RecyclerViewJiraIssueAdapter
        ) {
            try {
...
//            alertDialogItemDelete.show()
        ...
        private fun buttonClicksGithubPopup(fileList: ArrayList<RecyclerViewModelIssue>, position: Int, adapter: RecyclerViewJiraIssueAdapter) {
            buttonYes.setSafeOnClickListener {
                fileList.removeAt(position)
                arrayListIssueNames = fileList
                adapter.notifyDataSetChanged()
                if(fileList.size <=0){
