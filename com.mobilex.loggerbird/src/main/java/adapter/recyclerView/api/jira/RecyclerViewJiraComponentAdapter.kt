...
import models.recyclerView.RecyclerViewModelComponent
import services.LoggerBirdService

//Custom recyclerView adapter class for jira component.
/**
...
internal class RecyclerViewJiraComponentAdapter(
    ...
    class ViewHolder(view: View) : RecyclerView.ViewHolder(view) {
         ...
         * @param componentAdapter is used for getting reference of the custom recyclerView adapter class.
