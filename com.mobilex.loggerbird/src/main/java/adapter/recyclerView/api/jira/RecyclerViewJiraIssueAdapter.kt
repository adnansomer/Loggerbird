...
import models.recyclerView.RecyclerViewModelIssue
import services.LoggerBirdService

//Custom recyclerView adapter class for jira issues.
/**
...
internal class RecyclerViewJiraIssueAdapter(
    ...
    class ViewHolder(view: View) : RecyclerView.ViewHolder(view) {
         ...
         * @param issueAdapter is used for getting reference of the custom recyclerView adapter class.
