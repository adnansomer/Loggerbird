...
import models.recyclerView.RecyclerViewModelFixVersions
import services.LoggerBirdService

//Custom recyclerView adapter class for jira fix-versions.
/**
...
internal class RecyclerViewJiraFixVersionsAdapter(
    ...
    class ViewHolder(view: View) : RecyclerView.ViewHolder(view) {
         ...
         * @param fixVersionsAdapter is used for getting reference of the custom recyclerView adapter class.
