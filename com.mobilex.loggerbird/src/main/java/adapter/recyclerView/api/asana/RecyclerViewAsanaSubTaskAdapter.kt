package adapter.recyclerView.api.asana

import adapter.autoCompleteTextViews.api.asana.AutoCompleteTextViewAsanaSubAdapter
...
//Custom recyclerView adapter class for asana sub-task.
/**
...
internal class RecyclerViewAsanaSubTaskAdapter(
    ...
    class ViewHolder(view: View) : RecyclerView.ViewHolder(view) {
         ...
         * @param subtaskAdapter is used for getting reference of the custom recyclerView adapter class.
