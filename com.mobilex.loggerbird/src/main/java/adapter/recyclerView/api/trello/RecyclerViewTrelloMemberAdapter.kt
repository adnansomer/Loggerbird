...
import models.recyclerView.RecyclerViewModelMember
import services.LoggerBirdService

//Custom recyclerView adapter class for trello member.
/**
...
internal class RecyclerViewTrelloMemberAdapter(
    ...
    class ViewHolder(view: View) : RecyclerView.ViewHolder(view) {
         ...
         * @param memberAdapter is used for getting reference of the custom recyclerView adapter class.
